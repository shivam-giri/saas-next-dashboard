...
function InviteError({ message }: { message: string }) {
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#0F0F1A] p-4">
            <div className="bg-[#1A1A2E] border border-red-100 rounded-2xl shadow-lg p-10 max-w-md w-full text-center">
                <div className="w-14 h-14 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-5">
                    <svg className="w-7 h-7 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v4m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" />
                    </svg>
                </div>
                <h1 className="text-xl font-bold text-[#E5E7EB] mb-2">Invitation Unavailable</h1>
                <p className="text-[#9CA3AF] text-lg mb-6">{message}</p>
                <a
                    href="/"
                    className="inline-block bg-[linear-gradient(135deg,#8B5CF6,#22D3EE)] hover:opacity-90 text-white font-medium py-2 px-6 rounded-lg transition text-lg"
                >
                    Go to Homepage
                </a>
            </div>
