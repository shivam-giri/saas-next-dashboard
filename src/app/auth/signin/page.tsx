                ...
                <div className="mt-8">
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-3">
                        ...
                        >
                            <button
                                type="submit"
                                className="w-full flex justify-center items-center py-2.5 px-4 border border-white/40 rounded-lg shadow-sm bg-[#1A1A2E] text-lg font-medium text-[#E5E7EB] hover:bg-[#0F0F1A] transition"
                            >
