  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        ...
        {/* FREE PLAN */}
        <div className="border rounded-2xl p-8 bg-white shadow-sm opacity-60">
          ...
          <ul className="mt-8 space-y-4">
            <li className="flex items-center text-sm"><span className="mr-3">✅</span> Up to 3 users</li>
            <li className="flex items-center text-sm"><span className="mr-3">✅</span> Basic analytics</li>
            <li className="flex items-center text-sm"><span className="mr-3">❌</span> Priority support</li>
          </ul>
        </div>

        {/* PRO PLAN */}
        <div className="border-2 border-blue-600 rounded-2xl p-8 bg-white shadow-md relative">
          <div className="absolute top-0 right-6 transform -translate-y-1/2 bg-blue-600 text-white px-3 py-1 text-xs font-bold uppercase rounded-full tracking-wide">Most Popular</div>
          <h3 className="text-2xl font-bold text-slate-900">Pro</h3>
          <div className="mt-4 text-4xl font-extrabold text-slate-900">$29<span className="text-lg font-medium text-gray-500">/mo</span></div>
          <ul className="mt-8 space-y-4">
            <li className="flex items-center text-sm"><span className="mr-3">✅</span> Unlimited users</li>
            <li className="flex items-center text-sm"><span className="mr-3">✅</span> Advanced analytics backend</li>
            <li className="flex items-center text-sm"><span className="mr-3">✅</span> Priority support</li>
          </ul>
            ...
            <form action={checkoutAction}>
              <button 
                ...
                className={`w-full font-bold py-3 px-4 rounded-xl transition ${
                  isPro || membership.role !== "ADMIN" ? 'bg-gray-200 text-gray-500 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 text-white shadow-sm'
                }`}
              >
