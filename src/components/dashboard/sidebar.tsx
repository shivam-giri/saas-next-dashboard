...
export function Sidebar({
  ...
  return (
    <aside className="w-64 bg-slate-900 dark:bg-slate-950 text-slate-300 flex-col hidden md:flex">
      {/* Workspace Branding */}
      <div className="p-4 h-16 flex items-center border-b border-slate-800 bg-slate-950 dark:bg-black">
      ...
      <div className="p-4 border-t border-slate-800 bg-slate-950/50 dark:bg-black/30 flex items-center justify-between">
